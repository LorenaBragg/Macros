...
//Save results
roiManager("Select all");
roiManager("Save", "/Volumes/Lorena 113/Results/E2+Syt2_"+title+".zip");
selectWindow("Results"); 
saveAs("Results", "/Volumes/Lorena 113/Results/E2+Syt2_Results"+title+".xls");
selectWindow("Summary");
saveAs("Results", "/Volumes/Lorena 113/Results/E2+Syt2_Summary"+title+".xls");

selectWindow("Composite");
run("RGB Color");
saveAs("Tiff", "/Volumes/Lorena 113/Results/E2+Syt2_Results"+title+".tif");